...
class ProfilePublicController extends Controller
{
    ...
    public function getPublicProfile($username)
    {
        ...
        $publicData = [
            ...
            'courses' => $this->getUserPublicCourses($user),
            'certificates' => $this->getUserPublicCertificates($user),
    ...
    private function getUserPublicCourses($user)
    {
        $preferences = $user->preferences ?? [];
    ...
    private function getUserPublicCertificates($user)
    {
        $preferences = $user->preferences ?? [];
        $showCertificates = $preferences['show_certificates'] ?? true;
