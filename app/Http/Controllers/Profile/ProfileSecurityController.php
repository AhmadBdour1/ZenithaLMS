...
class ProfileSecurityController extends Controller
{
    ...
    public function getSecuritySettings()
    {
        ...
        $settings = [
            ...
            'devices' => [
                'trusted_devices' => $this->getUserTrustedDevices($user),
    ...
    public function revokeSession(Request $request)
    {
        ...
        // Revoke the session
        $this->revokeUserSession($user, $sessionId);
    ...
    public function addTrustedDevice(Request $request)
    {
        ...
        $user = Auth::user();
        $device = $this->addUserTrustedDevice($user, $request->device_name, $request->device_fingerprint);
    ...
    public function removeTrustedDevice(Request $request)
    {
        ...
        $user = Auth::user();
        $this->removeUserTrustedDevice($user, $request->device_id);
    ...
    private function getUserTrustedDevices($user)
    {
    ...
    private function revokeUserSession($user, $sessionId)
    {
    ...
    private function addUserTrustedDevice($user, $deviceName, $fingerprint)
    {
    ...
    private function removeUserTrustedDevice($user, $deviceId)
    {
