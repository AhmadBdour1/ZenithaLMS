...
class ZenithaLmsEbookController extends Controller
{
    ...
    /**
     * Admin: Display all ebooks for management
     */
    public function adminIndex(Request $request)
    {
        ...
        return view('zenithalms.ebooks.admin', compact('ebooks'));
    }

    /**
     * Admin: Display ebook details for management
     */
    public function adminShow($id)
    {
        ...
        return view('zenithalms.ebooks.admin-show', compact('ebook'));
    }
    ...
    public function adminEdit($id)
    {
        ...
        return view('zenithalms.ebooks.admin-edit', compact('ebook', 'categories'));
    }
    ...
    public function adminUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('zenithalms.ebooks.admin')
            ->with('success', 'Ebook updated successfully!');
    }
    ...
    {
        $ebook = Ebook::findOrFail($id);
        $ebook->is_featured = !$ebook->is_featured;
        $ebook->save();

        return response()->json([
            'success' => true,
            'message' => 'Ebook featured status updated successfully',
