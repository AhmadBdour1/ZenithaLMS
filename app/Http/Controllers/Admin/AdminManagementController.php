...
class AdminManagementController extends Controller
{
    ...
    public function getUsers(Request $request)
    {
        ...
        $users = $query->with(['roles', 'organization'])
            ->withExists(['courses as has_courses'])
    ...
    public function getSubscriptions(Request $request)
    {
        ...
        $subscriptions = $query->with(['organization'])
            ->orderBy($request->sort_by ?? 'created_at', $request->sort_order ?? 'desc')
            ->paginate($request->per_page ?? 20);
    ...
    public function getCategories(Request $request)
    {
        ...
        $categories = $query->withCount('courses')->paginate(15);
    ...
    public function createLesson()
    {
        return response()->json([
            'success' => true,
            'message' => 'Lesson creation feature coming soon'
        ]);
    }
    ...
    public function storeLesson(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'Lesson storage feature coming soon'
        ]);
    }
    ...
    public function updateLesson(Request $request, $id)
    {
        return response()->json([
            'success' => true,
            'message' => 'Lesson update feature coming soon'
        ]);
    }
    ...
    public function deleteLesson($id)
    {
        return response()->json([
            'success' => true,
            'message' => 'Lesson deletion feature coming soon'
        ]);
    }
    ...
    public function getQuizzes(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'Quizzes feature coming soon',
            'data' => []
        ]);
    }
    ...
    public function createQuiz()
    {
        return response()->json([
            'success' => true,
            'message' => 'Quiz creation feature coming soon'
        ]);
    }
    ...
    public function storeQuiz(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'Quiz storage feature coming soon'
        ]);
    }
    ...
    public function updateQuiz(Request $request, $id)
    {
        return response()->json([
            'success' => true,
            'message' => 'Quiz update feature coming soon'
        ]);
    }
    ...
    public function deleteQuiz($id)
    {
        return response()->json([
            'success' => true,
            'message' => 'Quiz deletion feature coming soon'
        ]);
    }
    ...
    public function getGeneralSettings()
    {
        return response()->json([
            'success' => true,
            'message' => 'General settings feature coming soon',
            'data' => []
        ]);
    }
    ...
    public function updateGeneralSettings(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'General settings update feature coming soon'
        ]);
    }
    ...
    public function updateEmailSettings(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'Email settings update feature coming soon'
        ]);
    }
    ...
    public function getSecuritySettings()
    {
        return response()->json([
            'success' => true,
            'message' => 'Security settings feature coming soon',
            'data' => []
        ]);
    }
    ...
    public function updateSecuritySettings(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'Security settings update feature coming soon'
        ]);
    }
    ...
    public function getUserReports(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'User reports feature coming soon',
            'data' => []
        ]);
    }
    ...
    public function getRevenueReports(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'Revenue reports feature coming soon',
            'data' => []
        ]);
    }
    ...
    public function getActivityReports(Request $request)
    {
        return response()->json([
            'success' => true,
            'message' => 'Activity reports feature coming soon',
            'data' => []
        ]);
    }
}
