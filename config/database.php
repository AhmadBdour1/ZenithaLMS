    ...
    'connections' => [
        ...
        */
        ...
        'central' => [
            ...
            'database' => env('CENTRAL_DB_DATABASE', env('DB_DATABASE', 'zenithalms_central')),
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                (PHP_VERSION_ID >= 80500 ? \Pdo\Mysql::ATTR_SSL_CA : \PDO::MYSQL_ATTR_SSL_CA) => env('CENTRAL_DB_SSL_CA', env('MYSQL_ATTR_SSL_CA')),
            ]) : [],
        ],
