    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 admin-card" style="border-left-color: #ef4444;">
                ...
                <div class="space-y-2">
                    ...
                    <a href="#" onclick="alert('User creation feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-red-50 transition-colors">
                        <div class="flex items-center">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 admin-card" style="border-left-color: #3b82f6;">
                ...
                <div class="space-y-2">
                    ...
                    <a href="#" onclick="alert('Course creation feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors">
                        <div class="flex items-center">
                            <span class="material-icons-round text-sm mr-2">add</span>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 admin-card" style="border-left-color: #10b981;">
                ...
                <div class="space-y-2">
                    <a href="/ebooks/admin" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-green-50 transition-colors">
                        <div class="flex items-center justify-between">
                            <span class="font-medium">Ebooks</span>
                            <span class="text-sm text-gray-500">{{ App\Models\Ebook::count() }}</span>
                        </div>
                    </a>
                    <a href="#" onclick="alert('Lessons feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-green-50 transition-colors">
                        <div class="flex items-center">
                            <span class="material-icons-round text-sm mr-2">video_library</span>
                            <span class="font-medium">Lessons</span>
                        </div>
                    </a>
                    <a href="#" onclick="alert('Quizzes feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-green-50 transition-colors">
                        <div class="flex items-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="#" onclick="alert('Activity log feature coming soon')" class="text-blue-600 hover:text-blue-700 text-sm">View all</a>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <a href="#" onclick="alert('General settings feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition-colors">
                        <div class="flex items-center">
                            <span class="material-icons-round text-sm mr-2">tune</span>
                            <span class="font-medium">General Settings</span>
                        </div>
                    </a>
                    <a href="#" onclick="alert('Email settings feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition-colors">
                        <div class="flex items-center">
                            <span class="material-icons-round text-sm mr-2">email</span>
                            <span class="font-medium">Email Configuration</span>
                        </div>
                    </a>
                    <a href="#" onclick="alert('Security settings feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-purple-50 transition-colors">
                        <div class="flex items-center">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <a href="#" onclick="alert('User reports feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors">
                        <div class="flex items-center">
                            <span class="material-icons-round text-sm mr-2">people</span>
                            <span class="font-medium">User Reports</span>
                        </div>
                    </a>
                    <a href="#" onclick="alert('Revenue reports feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors">
                        <div class="flex items-center">
                            <span class="material-icons-round text-sm mr-2">payments</span>
                            <span class="font-medium">Revenue Reports</span>
                        </div>
                    </a>
                    <a href="#" onclick="alert('Activity reports feature coming soon')" class="block w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors">
                        <div class="flex items-center">
