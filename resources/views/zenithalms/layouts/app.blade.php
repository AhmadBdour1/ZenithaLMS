            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    @guest
                        ...
                        <a href="/courses" class="px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" aria-label="{{ __('Browse courses and get started') }}">
                            {{ __('Get Started') }}
                        </a>
                    ...
                    @auth
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('dashboard') }}" class="text-neutral-600 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md p-2" aria-label="{{ __('Go to dashboard') }}">
                                {{ __('Dashboard') }}
                            </a>
                            @if(Route::has('profile.edit'))
                            <a href="{{ route('profile.edit') }}" class="text-neutral-600 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md p-2" aria-label="{{ __('View your profile') }}">
                                {{ __('Profile') }}
                            </a>
                        @else
                            <a href="{{ route('dashboard') }}" class="text-neutral-600 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-md p-2" aria-label="{{ __('View your profile') }}">
                                {{ __('Profile') }}
                            </a>
                        @endif
